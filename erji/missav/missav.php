...
array_push($videos4,
    ...
    [
        "id" => "/dm32774/cn/1pondo",
        "title" => "一本道"
    ],
    [
        "id" => "/dm58571/cn/caribbeancom",
        "title" => "Caribbeancom"
    ],
    [
        "id" => "/dm934/cn/caribbeancompr",
        "title" => "caribbeancompr"
    ],
    [
        "id" => "/dm29862/cn/10musume",
        "title" => "10musume"
    ],
    [
        "id" => "/dm497/cn/pacopacomama",
        "title" => "pacopacomama"
    ],
    [
        "id" => "/dm108/cn/gachinco",
        "title" => "gachinco"
    ],
    [
        "id" => "/dm25/cn/xxxav",
...
$response['sort'] ='中文字幕-日本AV-素人-无码影片-国产AV';
$response['中文字幕'] = $videos1;
$response['日本AV'] = $videos2;
$response['素人'] = $videos3;
$response['无码影片'] = $videos4;
$response['国产AV'] = $videos5;



// 设置 code 为 ok 或 null
    $response['code'] = !empty($videos5) ? 'ok' : 'null';
            ...
            if(trim($segment) != "") {
                ...
                if (!empty($image_match[1])) {
                    ...
                    $video = array(
						...
						"title" => isset($title_match[2]) ? $title_match[2] : ""
                    );
                    $videos[] = $video;
                }
            }
