...
function decryptDataFromURL($url) {
  ...
  //header('Content-Type: application/json');
	...
	//token经常会变  需要重新抓包
	$token = 'token=eyJ1c2VyX2lkIjoyNDkzOTE3NTgsImxhc3Rsb2dpbiI6NCwiZXhwaXJlZCI6MTcxNTM1MDg0OH0.b948909bb5f90a69c62df8410f8058b4.8a890eec369f65d4e80af9868ebe860d62ce11349b82d0b4ed8d06ba';
	
	
    //最新落地页  在进入首页时，地址栏会显示 下面的3个url
	$newurl =  'https://pwc-aws.aregizx.com';
	//https://pwc-aws.aregizx.com
	
    $latestdomain = 'https://pwc-aws.wfjcm.com';
    
	//host  id处需要
	$host =  'https://tez.ntklz.com';
...
$response['categories'] = $videos;
   ...
   // } else {
      ...
      $sourceUrl =  $latestdomain . "/api/v4/menu/$category/layout/" . (($category - 13) * 7 + 17) ."?$token&page=$page";
		...
		$sourceUrl =  $latestdomain . "/api/v4/menu/$category/layout/" . (($category - 18) * 7 + 46) ."?$token&page=$page";
	  }
...
//$sourceUrl = "https://pwc-aws.aregizx.com/api/v2/long/info/225341?token=eyJ1c2VyX2lkIjoyNDkzOTE3NTgsImxhc3Rsb2dpbiI6NCwiZXhwaXJlZCI6MTcxNTM0MDU2Nn0.42d0b5e5b8a51a416d3dae518ee35070.1bf8a2f7e184da5a528d209dce3afa79498c241d63359a182de6cb6a&host=https://tez.ntklz.com";
