...
if (!empty($dataArray['list'][0])) {
    ...
    $response['novel'] ='<style>p { font-size: 20px; }</style>' .  str_replace("gif\"/>","gif\" alt=\"\" style=\"max-width:100%;\">",str_replace("jpg\"/>","jpg\" alt=\"\" style=\"max-width:100%;\">", $dataArray['list'][0]['art_content']));
