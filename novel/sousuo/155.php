...
if (!empty($dataArray['list'][0])) {
    ...
    $response['novel'] =str_replace("border=\"0\">","border=\"0\" alt=\"\" style=\"max-width:100%;\">",str_replace("gif\"/>","gif\" alt=\"\" style=\"max-width:100%;\">",str_replace("jpg\"/>","jpg\" alt=\"\" style=\"max-width:100%;\">", $dataArray['list'][0]['art_content'])));
